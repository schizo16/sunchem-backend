...
func SeedDB(db *gorm.DB) {
	...
	products := []struct {
		...
		{Slug: "nhua-nhu-tuong-sunperse-c-68", Name: "NHỰA NHŨ TƯƠNG SUNPERSE C-68", Category: "HÓA CHẤT NGÀNH SƠN", Desc: "SUNPERSE C-68 là nhựa nhũ tương trên cơ sở copolymer styrene acrylic, được dùng làm chất tạo màng trong các hệ chống thấm trộn xi măng. Sunperse C-68 có khả năng kháng nước rất cao cùng độ mềm dẻo cực tốt.", Image: "", Highlights: "Chống thấm,Kháng nước cao,Mềm dẻo,Hệ xi măng"},
		{Slug: "nhua-nhu-tuong-sunperse-c-77", Name: "NHỰA NHŨ TƯƠNG SUNPERSE C-77", Category: "HÓA CHẤT NGÀNH SƠN", Desc: "SUNPERSE C-77 là nhựa nhũ tương trên cơ sở copolymer styrene acrylic, có các hạt nhũ với kích thước siêu nhỏ và đồng nhất. Sản phẩm có khả năng kết dính bột màu vượt trội.", Image: "", Highlights: "Kết dính bột màu,Không dính tay,Tương thích tốt"},
		{Slug: "titanium-dioxit-rutile-r668", Name: "RUTILE TITAN DIOXIT R668", Category: "HÓA CHẤT NGÀNH SƠN", Desc: "TiO2 R668 có hàm lượng TiO2 93%, ánh vàng, hạt titan được bọc nhiều lớp, độ phủ, độ bền thời tiết tốt, thường được dùng cho các dòng sơn nội thất và ngoại thất kinh tế.", Image: "", Highlights: "TiO2 93%,Ánh vàng,Sơn nội/ngoại thất,Độ bền thời tiết"},
		{Slug: "phan-tan-cao-cap-pidicryl-120v", Name: "PHÂN TÁN CAO CẤP PIDICRYL 120V", Category: "HÓA CHẤT NGÀNH SƠN", Desc: "Pidicryl 120v là một loại phụ gia phân tán cao cấp dùng cho hệ sơn và mực in gốc nước. Có khả năng phân tán và ổn định bột màu vô cơ và hữu cơ, đặc biệt là bột màu đen carbon.", Image: "", Highlights: "Phân tán cao cấp,Ổn định bột màu đen,Cải thiện lưu biến,Sơn & mực in"},
		{Slug: "mau-paste-goc-nuoc", Name: "MÀU PHA MÁY SMARTIN", Category: "HÓA CHẤT NGÀNH SƠN", Desc: "Màu paste các màu hữu cơ hoặc vô cơ đã được nghiền mịn sẵn thành dạng sệt phân tán trong nước. Khi pha màu sơn, chỉ cần cho màu vào base trắng và điều chỉnh tỷ lệ phù hợp.", Image: "", Highlights: "Màu paste,Pha máy tự động,Độ bền cao,Phân phối độc quyền"},

		{Slug: "cabelec-xs6639c", Name: "CABELEC XS6639C", Category: "HÓA CHẤT NGÀNH NHỰA", Desc: "CABELEC XS6639C là một loại hạt chống tĩnh điện cao cấp của CABOT, chứa hàm lượng cao hạt carbon ở dạng ống nano, được thiết kế để loại bỏ hiện tượng tĩnh điện trên các sản phẩm nhựa PE, PP.", Image: "", Highlights: "Chống tĩnh điện,Công nghệ nano,CABOT USA,PE & PP"},
		{Slug: "plasblak-pe2705", Name: "PLASBLAK PE2705", Category: "HÓA CHẤT NGÀNH NHỰA", Desc: "PLASBLAK PE2705 là hạt masterbatch màu đen, chứa tới 50% hạt carbon trên nhựa nền PE. Đặc biệt PE2705 có thể dùng để nhuộm màu đen cho các loại nhựa ABS, SAN, PS.", Image: "", Highlights: "Carbon 50%,Đa nền nhựa,CABOT USA,Màu đen sâu"},
		{Slug: "titanium-dioxit-rutile-r902", Name: "RUTILE TITAN DIOXIT R902", Category: "HÓA CHẤT NGÀNH MỰC IN", Desc: "TiO2 R902+ có Hàm lượng TiO2 93%, ánh trung tính, được sử dụng nhiều trong các dòng sơn gỗ, sơn dung môi.", Image: "", Highlights: "TiO2 93%,Ánh trung tính,Sơn gỗ & dung môi,Chemours"},
		{Slug: "titanium-dioxit-rutile-r706-1", Name: "RUTILE TITAN DIOXIT R706", Category: "HÓA CHẤT NGÀNH MỰC IN", Desc: "TiO2 R706 có Hàm lượng TiO2 93%, ánh xanh, hạt titan được xử lý bọc nhiều lớp cho độ phủ, độ bền thời tiết tốt, được sử dụng nhiều trong các dòng sơn nước ngoại thất và nội thất cao cấp.", Image: "", Highlights: "TiO2 93%,Ánh xanh,Sơn nước cao cấp,Chemours"},
